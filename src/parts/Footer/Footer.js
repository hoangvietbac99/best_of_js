        ...
        <div className={cx('container')}>
          <section className={cx('footer-top')}>
            <div className={cx('logo-github')}>
              <img className={cx('logo')} src={logos.logoFooter} alt="" />
                ...
                {directLinks.map((direct, index) => (
                  <li key={index} className={cx('item')}>
                    <div className={cx('link-to-page')}>
                      <Link to={direct.to}>{direct.title}</Link>
                    </div>
                    <span>{direct.p}</span>
                  </li>
                ))}
              ...
              <div className={cx('rising-state')}>
                <div className={cx('rising')}>
                  <div className={cx('link')}>
                    <a href="https://risingstars.js.org/2022/en" target="blank">
                      JavaScript Rising Stars
                      <FontAwesomeIcon className={cx('icon')} icon={faRightFromBracket} />
                    </a>
                  </div>
                  <span>Our annual round-up about the JavaScript landscape</span>
                </div>
                <div className={cx('img')}>
                  <img className={cx('img-js')} src={logos.risingStars} alt="" />
                </div>
                <div className={cx('rising')}>
                  <div className={cx('link')}>
                    <a href="https://risingstars.js.org/2022/en" target="blank">
                  ...
                  <span>The biggest annual JavaScript-specific survey</span>
                </div>
              </div>
            </div>
          </section>
          <section className={cx('footer-bottom')}>
            <div className={cx('wrapper-bt')}>
              <div className={cx('paragraph')}>
                <p>
                  Data is updated from GitHub everyday, the last update was 13 hours ago (at 4:23
                  AM).
                </p>
              </div>
              <div className={cx('paragraph')}>
                <p>
                  ...
                  <a href="https://www.michaelrambeau.com/">Michael Rambeau</a>, made in Osaka,
                  Japan.
                </p>
              </div>
              <div className={cx('paragraph')}>
                <p>
                  ...
                  <a href="https://vercel.com/">
                    <img src="https://bestofjs.org/svg/vercel.svg" alt="" />
                  </a>
                </p>
              </div>
            </div>
